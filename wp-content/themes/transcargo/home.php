...
<div class="main home">
    ...
    <div class="home-slider" id="js-home-slider">
        ...
        <!--  home-slider__item  -->
        <div class="home-slider__item" style="background-image: url('<?php bloginfo('template_url');?>/assets/i/home/home-slider-1.jpg')">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="caption">
                            ...
                            <h2 class="slider-title">Large number of freight ways makes us powerful</h2>

                            <p class="slider-text">
                                Nunc accumsan metus quis metus. Sed luctus. Mauris eu enim quisque dignissim nequesudm
                                consectetuer dapibus wn eu leo integer varius erat.
                            </p>
        ...
        <!--  home-slider__item  -->
        <div class="home-slider__item" style="background-image: url('<?php bloginfo('template_url');?>/assets/i/home/home-slider-2.jpg')">
        ...
        <!--  home-slider__item  -->
        <div class="home-slider__item" style="background-image: url('<?php bloginfo('template_url');?>/assets/i/home/home-slider-3.jpg')">
